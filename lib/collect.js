  ...
  contentType: (asset, myPage) => {
    if (asset.status === 200) {
      ...
      if (myPage.contentTypes[asset.type]) {
       ...
       if (myPage.contentTypes.other) {
        myPage.contentTypes.other.requests += 1;
        // header vs content size?
        // Firefox sometimes has asset size -1 in HAR files
        myPage.contentTypes.other.transferSize += asset.transferSize > 0 ?
          asset.transferSize : 0;
        myPage.contentTypes.other.contentSize += asset.contentSize > 0 ?
          asset.contentSize : 0;
        myPage.contentTypes.other.headerSize += asset.headerSize > 0 ?
          asset.headerSize : 0;
      } else {
        myPage.contentTypes.other = {
          transferSize: asset.transferSize > 0 ? asset.transferSize : 0,
          contentSize: asset.contentSize > 0 ? asset.contentSize : 0,
          headerSize: asset.headerSize > 0 ? asset.headerSize : 0,
          requests: 1,
